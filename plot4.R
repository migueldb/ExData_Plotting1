...
## course-project-1
## plot4.R - This script generates the fourth assingment plot
...
## Prepare the plot area for multiple plots
par(mfcol = c(2, 2))
...
## 2nd Plot
## Generate the line plot for the first variable
plot(
    exdata$posixtime,
    exdata$submetering1,
    type = "l",
...
## Add line plot for the second variable
points(exdata$posixtime, exdata$submetering2, col = "red", type = "l" )

## Add line plot for the third variable
points(exdata$posixtime, exdata$submetering3, col = "blue", type = "l" )
